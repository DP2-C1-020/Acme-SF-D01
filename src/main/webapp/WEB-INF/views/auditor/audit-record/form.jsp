...
<acme:form>
	...
	<acme:input-textbox code="auditor.auditrecord.form.label.initialMoment" path="initialMoment" placeholder="auditor.auditrecord.form.placeholder.date"/>
	<acme:input-textbox code="auditor.auditrecord.form.label.finalMoment" path="finalMoment" placeholder="auditor.auditrecord.form.placeholder.date"/>
