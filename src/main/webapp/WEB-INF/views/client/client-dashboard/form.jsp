    ...
    <jstl:forEach var="s" items="${currency}">
        ...
        <table class="table table-sm">
            <tr>
                ...
                <td class="align-right">
                    <acme:print value="${averageBudget[s] == null? nullValues: averageBudget[s]}"/>
                </td>
            </tr>
            <tr>
                <th scope="row">
                ...
                <td class="align-right">
                    <acme:print value="${deviationBudget[s] == null? nullValues: deviationBudget[s]}"/>
                </td>
            </tr>
            <tr>
                <th scope="row">
                ...
                <td class="align-right">
                    <acme:print value="${minBudget[s] == null? nullValues: minBudget[s]}"/>
                </td>
            </tr>
            <tr>
                <th scope="row">
                ...
                <td class="align-right">
                    <acme:print value="${maxBudget[s] == null? nullValues: maxBudget[s]}"/>
                </td>
            </tr>
        </table>
    </jstl:forEach>
