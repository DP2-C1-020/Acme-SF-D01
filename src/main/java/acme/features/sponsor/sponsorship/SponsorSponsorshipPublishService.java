...
public class SponsorSponsorshipPublishService extends AbstractService<Sponsor, Sponsorship> {
	...
	public void validate(final Sponsorship sponsorship) {
		...
		if (!super.getBuffer().getErrors().hasErrors("amount")) {
			...
			Double tempAmount = this.repository.computeValidTotalAmountBySponsorshipId(sponsorship.getId(), currentDate);
		...
		unpublishedInvoices = this.repository.totalUnpublishedValidInvoices(sponsorship.getId(), currentDate);
